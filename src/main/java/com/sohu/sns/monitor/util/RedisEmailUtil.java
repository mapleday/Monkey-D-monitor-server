...
public class RedisEmailUtil {
    ...
    public static final String KEYS_EXCEPTION = "<br><br>2.keys不一致的Master-Slave结点为: %s";
    public static final String GROW_EXCEPTION = "<br><br>3.KEYS较上次统计增幅超过10%%的Redis实例为: %s";
    public static final String DECLINE_EXCEPTION = "<br><br>4.KEYS较上次统计下降10%%的Redis实例为: %s";
