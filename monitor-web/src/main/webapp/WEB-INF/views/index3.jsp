        ...
        $(document).ready(function() {
            ...
            editor = new $.fn.dataTable.Editor( {
                ...
                fields: [ {
                    ...
                    label: "monitor_time_out:",
                    name: "monitor_time_out"
                }, {
                    label: "monitor_time_interval:",
                    name: "monitor_time_interval"
                }, {
                    label: "monitor_times:",
                    name: "monitor_times"
                }, {
            ...
            $('#example').DataTable( {
                dom: "Bfrtip",
                ajax: "http://localhost:8080/getHttpResourcelist",
                columns: [
                    { data: "DT_RowId" },
                    { data: "resource_name" },
                    { data: "monitor_time_out" },
                    { data: "monitor_time_interval" },
                    { data: "monitor_times" },
                    { data: "alarm_threshold_times" }
                ],
                select: true,
                buttons: [
    ...
    <aside class="main-sidebar">
        ...
        <section class="sidebar">
            ...
            <ul class="sidebar-menu">
                ...
                <li class="active"><a href="#"><i class="fa fa-link"></i> <span>Link 123</span></a></li>
                <li><a href="#"><i class="fa fa-link"></i> <span>Another Link 456</span></a></li>
                <li class="treeview">
